...
namespace Hans.Contoso.Core.Search
{
    public class SessionFactorySearch : ISessionFactory
    {
        private readonly ISessionFactory _sessionFactory;

        public SessionFactorySearch(ISessionFactory sessionFactory)
        {
        ...
        {
            var session = _sessionFactory.OpenSession(conn, sessionLocalInterceptor);
            return WrapSession(session);
        }

        public ISession OpenSession(IInterceptor sessionLocalInterceptor)
        {
            var session = _sessionFactory.OpenSession(sessionLocalInterceptor);
            return WrapSession(session);
        }
